...
public class PartTreeDynamoDBQueryUnitTest {
    ...
    public void setUp() {
        Mockito.lenient().when(mockPlaylistEntityMetadata.isCompositeHashAndRangeKeyProperty("playlistId")).thenReturn(true);
        Mockito.lenient().when(mockPlaylistEntityMetadata.getHashKeyPropertyName()).thenReturn("userName");
        // Mockito.lenient().when(mockPlaylistEntityMetadata.isHashKeyProperty("userName")).thenReturn(true);
        Mockito.lenient().when(mockPlaylistEntityMetadata.getJavaType()).thenReturn(Playlist.class);
        Mockito.lenient().when(mockPlaylistEntityMetadata.getRangeKeyPropertyName()).thenReturn("playlistName");
        Mockito.lenient().when(mockPlaylistEntityMetadata.getIndexRangeKeyPropertyNames()).thenReturn(new HashSet<String>());
        Mockito.lenient().when(mockDynamoDBUserQueryMethod.getEntityInformation()).thenReturn(mockUserEntityMetadata);
        Mockito.lenient().when(mockDynamoDBUserQueryMethod.getParameters()).thenReturn(mockParameters);
        Mockito.lenient().when(mockDynamoDBUserQueryMethod.getConsistentReadMode()).thenReturn(QueryConstants.ConsistentReadMode.DEFAULT);
        Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.getEntityInformation()).thenReturn(mockPlaylistEntityMetadata);
        Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.getParameters()).thenReturn(mockParameters);
        Mockito.lenient().when(mockUserEntityMetadata.getHashKeyPropertyName()).thenReturn("id");
        // Mockito.lenient().when(mockUserEntityMetadata.isHashKeyProperty("id")).thenReturn(true);
        Mockito.lenient().when(mockUserEntityMetadata.getJavaType()).thenReturn(User.class);
        Mockito.lenient().when(mockDynamoDBUserQueryMethod.isScanEnabled()).thenReturn(true);
        Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.isScanEnabled()).thenReturn(true);
    ...
    private <T, ID extends Serializable> void setupCommonMocksForThisRepositoryMethod(
        ...
        if (rangeKeyProperty != null) {
            Mockito.lenient().when(mockEntityMetadata.isRangeKeyAware()).thenReturn(true);
        }

        Mockito.lenient().when(mockDynamoDBQueryMethod.getEntityType()).thenReturn(clazz);
        Mockito.lenient().when(mockDynamoDBQueryMethod.getName()).thenReturn(repositoryMethodName);
        Mockito.lenient().when(mockDynamoDBQueryMethod.getParameters()).thenReturn(mockParameters);
        Mockito.lenient().when(mockDynamoDBQueryMethod.getConsistentReadMode()).thenReturn(QueryConstants.ConsistentReadMode.DEFAULT);
        Mockito.lenient().when(mockParameters.getBindableParameters()).thenReturn(mockParameters);
        Mockito.lenient().when(mockParameters.getNumberOfParameters()).thenReturn(numberOfParameters);
        // Mockito.lenient().when(mockDynamoDBQueryMethod.getReturnedObjectType()).thenReturn(clazz);
        if (hashKeyProperty != null) {
            // Mockito.lenient().when(mockEntityMetadata.isHashKeyProperty(hashKeyProperty)).thenReturn(true);
        }

        for (int i = 0; i < numberOfParameters; i++) {
            Parameter mockParameter = Mockito.mock(Parameter.class);
            Mockito.lenient().when(mockParameter.getIndex()).thenReturn(i);
            Mockito.lenient().when(mockParameters.getBindableParameter(i)).thenReturn(mockParameter);
        }
    ...
    public void testExecute_WhenFinderMethodIsFindingSingleEntity_WithSingleStringParameter_WhenFindingByHashKey() {
        ...
        // Mock out specific DynamoDBOperations behavior expected by this method
        Mockito.lenient().when(mockDynamoDBOperations.load(User.class, "someId")).thenReturn(mockUser);
    ...
    public void testExecute_WhenFinderMethodIsFindingSingleEntityWithCompositeId_WithSingleStringParameter_WhenFindingByHashAndRangeKey() {
        ...
        // Mock out specific DynamoDBOperations behavior expected by this method
        Mockito.lenient().when(mockDynamoDBOperations.load(Playlist.class, "someUserName", "somePlaylistName"))
    ...
    public void testExecute_WhenFinderMethodIsFindingSingleEntityWithCompositeId_WhenFindingByCompositeId() {
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.getRangeKey(playlistId)).thenReturn("somePlaylistName");
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WhenFindingByNotCompositeId() {
        assertThrows(UnsupportedOperationException.class, () -> {
            ...
            Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.isCollectionQuery()).thenReturn(true);
            ...
            // Mockito.lenient().when(mockPlaylistScanResults.get(0)).thenReturn(mockPlaylist);
            // Mockito.lenient().when(mockPlaylistScanResults.size()).thenReturn(1);
            // Mockito.lenient().when(mockDynamoDBOperations.scan(classCaptor.capture(),
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WhenFindingByRangeKeyOnly() {
        ...
        Mockito.lenient().when(mockPlaylistScanResults.get(0)).thenReturn(mockPlaylist);
        Mockito.lenient().when(mockPlaylistScanResults.size()).thenReturn(1);
        Mockito.lenient().when(mockDynamoDBOperations.scan(playlistClassCaptor.capture(), scanCaptor.capture()))
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WhenFindingByCompositeIdWithRangeKeyOnly() {
        ...
        Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.isCollectionQuery()).thenReturn(true);
        Mockito.lenient().when(mockPlaylistEntityMetadata.getHashKey(playlistId)).thenReturn(null);
        Mockito.lenient().when(mockPlaylistEntityMetadata.getRangeKey(playlistId)).thenReturn("somePlaylistName");
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WithSingleStringParameter_WhenFindingByHashKeyOnly() {
        ...
        Mockito.lenient().when(mockPlaylistQueryResults.get(0)).thenReturn(mockPlaylist);
        Mockito.lenient().when(mockPlaylistQueryResults.size()).thenReturn(1);
        Mockito.lenient().when(mockDynamoDBOperations.query(playlistClassCaptor.capture(), playlistQueryCaptor.capture()))
    ...
    public void testExecute_WhenFinderMethodIsCountingEntityWithCompositeIdList_WhenFindingByRangeKeyOnly_ScanCountEnabled() {
        ...
        Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.isCollectionQuery()).thenReturn(false);
        Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.isScanCountEnabled()).thenReturn(true);

        Mockito.lenient().when(mockDynamoDBOperations.count(playlistClassCaptor.capture(), scanCaptor.capture())).thenReturn(100);
    ...
    public void testExecute_WhenFinderMethodIsCountingEntityWithCompositeIdList_WhenFindingByRangeKeyOnly_ScanCountDisabled() {
        assertThrows(IllegalArgumentException.class, () -> {
            ...
            Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.isCollectionQuery()).thenReturn(false);
            Mockito.lenient().when(mockDynamoDBPlaylistQueryMethod.isScanCountEnabled()).thenReturn(false);
            ...
            // Mockito.lenient().when(mockDynamoDBOperations.count(classCaptor.capture(),
            // scanCaptor.capture())).thenReturn(
            // 100);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WithSingleStringParameter_WhenFindingByHashKeyAndNotRangeKey() {
        ...
        // Mockito.lenient().when(mockPlaylistEntityMetadata.getHashKeyPropotypeEntityForHashKey("someUserName")).thenReturn(
        // prototypeHashKey);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WhenFindingByCompositeId_HashKeyAndIndexRangeKey() {
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.getIndexRangeKeyPropertyNames()).thenReturn(indexRangeKeyPropertyNames);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WhenFindingByCompositeIdWithHashKeyOnly_WhenSortingByIndexRangeKey() {
        assertThrows(UnsupportedOperationException.class, () -> {
            ...
            // Mockito.lenient().when(mockPlaylistQueryResults.get(0)).thenReturn(mockPlaylist);
            // Mockito.lenient().when(mockPlaylistQueryResults.size()).thenReturn(1);
            // Mockito.lenient().when(mockDynamoDBOperations.query(classCaptor.capture(),
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WhenFindingByHashKeyAndIndexRangeKeyWithOveriddenName() {
        ...
        indexRangeKeyPropertyNames.add("displayName");
        Mockito.lenient().when(mockPlaylistEntityMetadata.getIndexRangeKeyPropertyNames()).thenReturn(indexRangeKeyPropertyNames);
        Mockito.lenient().when(mockPlaylistEntityMetadata.getOverriddenAttributeName("displayName"))
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeIdList_WhenFindingByCompositeIdWithHashKeyOnlyAndByAnotherPropertyWithOverriddenAttributeName() {
        ...
        // Mockito.lenient().when(mockUserScanResults.get(0)).thenReturn(mockUser);
        // Mockito.lenient().when(mockUserScanResults.size()).thenReturn(1);
        Mockito.lenient().when(mockDynamoDBOperations.scan(userClassCaptor.capture(), scanCaptor.capture()))
    ...
    public void testExecute_WhenFinderMethodIsFindingSingleEntity_WithSingleStringParameter_WhenNotFindingByHashKey_WhenDynamoAttributeNameOverridden() {
        setupCommonMocksForThisRepositoryMethod(mockUserEntityMetadata, mockDynamoDBUserQueryMethod, User.class,
                "findByName", 1, "id", null);
        Mockito.lenient().when(mockUserEntityMetadata.getOverriddenAttributeName("name")).thenReturn(Optional.of("Name"));
    ...
    public void testExecute_WhenFinderMethodIsFindingSingleEntity_WithMultipleStringParameters_WhenFindingByHashKeyAndANonHashOrRangeProperty_WhenDynamoDBAttributeNamesOveridden() {
        ...
        Mockito.lenient().when(mockUserEntityMetadata.getOverriddenAttributeName("name")).thenReturn(Optional.of("Name"));
        Mockito.lenient().when(mockUserEntityMetadata.getOverriddenAttributeName("id")).thenReturn(Optional.of("Id"));
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityList_WithSingleStringParameter_WhenNotFindingByHashKey() {
        setupCommonMocksForThisRepositoryMethod(mockUserEntityMetadata, mockDynamoDBUserQueryMethod, User.class,
                "findByName", 1, "id", null);
        Mockito.lenient().when(mockDynamoDBUserQueryMethod.isCollectionQuery()).thenReturn(true);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityList_WithSingleDateParameter_WithCustomMarshaller_WhenNotFindingByHashKey()
        ...
        Mockito.lenient().when(mockUserEntityMetadata.getMarshallerForProperty("joinYear")).thenReturn(marshaller);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityList_WithSingleDateParameter_WithCustomMarshaller_WhenFindingByGlobalSecondaryHashIndexHashKey()
        ...
        Mockito.lenient().when(mockDynamoDBUserQueryMethod.isCollectionQuery()).thenReturn(true);
        DynamoDBYearMarshaller marshaller = new DynamoDBYearMarshaller();
        Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexHashKeyProperty("joinYear")).thenReturn(true);
        ...
        Mockito.lenient().when(mockUserEntityMetadata.getGlobalSecondaryIndexNamesByPropertyName())
                .thenReturn(indexRangeKeySecondaryIndexNames);

        Mockito.lenient().when(mockUserEntityMetadata.getDynamoDBTableName()).thenReturn("user");

        // Mock out specific QueryRequestMapper behavior expected by this method
        Mockito.lenient().when(mockUserQueryResults.get(0)).thenReturn(mockUser);
        Mockito.lenient().when(mockUserQueryResults.size()).thenReturn(1);
        Mockito.lenient().when(mockDynamoDBOperations.query(userClassCaptor.capture(), queryResultCaptor.capture()))
                .thenReturn(mockUserQueryResults);
        Mockito.lenient().when(mockDynamoDBOperations.getOverriddenTableName(User.class, "user")).thenReturn("user");
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityList_WithDateParameterAndStringParameter_WithCustomMarshaller_WhenFindingByGlobalSecondaryHashAndRangeIndexHashAndRangeKey()
        ...
        Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexHashKeyProperty("joinYear")).thenReturn(true);
        Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexRangeKeyProperty("postCode")).thenReturn(true);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeKeyList_WhenFindingByGlobalSecondaryHashIndexHashKey()
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexHashKeyProperty("displayName")).thenReturn(true);
        Map<String, String[]> indexRangeKeySecondaryIndexNames = new HashMap<String, String[]>();
        indexRangeKeySecondaryIndexNames.put("displayName", new String[]{"DisplayName-index"});
        Mockito.lenient().when(mockPlaylistEntityMetadata.getGlobalSecondaryIndexNamesByPropertyName())
                .thenReturn(indexRangeKeySecondaryIndexNames);

        Mockito.lenient().when(mockPlaylistEntityMetadata.getDynamoDBTableName()).thenReturn("playlist");

        // Mock out specific QueryRequestMapper behavior expected by this method
        Mockito.lenient().when(mockPlaylistQueryResults.get(0)).thenReturn(mockPlaylist);
        Mockito.lenient().when(mockPlaylistQueryResults.size()).thenReturn(1);
        Mockito.lenient().when(mockDynamoDBOperations.query(playlistClassCaptor.capture(), queryResultCaptor.capture()))
                .thenReturn(mockPlaylistQueryResults);
        Mockito.lenient().when(mockDynamoDBOperations.getOverriddenTableName(Playlist.class, "playlist")).thenReturn("playlist");
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeKeyList_WhenFindingByGlobalSecondaryHashAndRangeIndexHashAndRangeKey_WhereSecondaryHashKeyIsPrimaryHashKey()
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexHashKeyProperty("userName")).thenReturn(true);
        // Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexRangeKeyProperty("displayName")).thenReturn(true);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeKeyList_WhenFindingByGlobalSecondaryHashAndRangeIndexHashAndRangeKey_WhereSecondaryHashKeyIsPrimaryRangeKey()
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexHashKeyProperty("playlistName")).thenReturn(true);
        // Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexRangeKeyProperty("displayName")).thenReturn(true);
        Map<String, String[]> indexRangeKeySecondaryIndexNames = new HashMap<String, String[]>();
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeKeyList_WhenFindingByGlobalSecondaryHashAndRangeIndexHashAndRangeKey_WhereSecondaryRangeKeyIsPrimaryRangeKey()
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexHashKeyProperty("displayName")).thenReturn(true);
        // Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexRangeKeyProperty("playlistName")).thenReturn(true);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityWithCompositeKeyList_WhenFindingByGlobalSecondaryHashAndRangeIndexHashAndRangeKey_WhereSecondaryRangeKeyIsPrimaryHashKey()
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexHashKeyProperty("displayName")).thenReturn(true);
        // Mockito.lenient().when(mockPlaylistEntityMetadata.isGlobalIndexRangeKeyProperty("userName")).thenReturn(true);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityByGlobalSecondaryHashAndRangeIndexHashAndRangeKeyNonEqualityCondition_WhereBothSecondaryHashKeyAndSecondaryIndexRangeKeyMembersOfMultipleIndexes()
        ...
        Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexHashKeyProperty("name")).thenReturn(true);
        Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexRangeKeyProperty("postCode")).thenReturn(true);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityByGlobalSecondaryHashAndRangeIndexHashCondition_WhereSecondaryHashKeyMemberOfMultipleIndexes()
        ...
        Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexHashKeyProperty("name")).thenReturn(true);
        // Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexRangeKeyProperty("postCode")).thenReturn(true);
        // Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexRangeKeyProperty("joinYear")).thenReturn(true);
        // Mockito.lenient().when(mockUserEntityMetadata.isGlobalIndexHashKeyProperty("id")).thenReturn(true);
    ...
    public void testExecute_WhenFinderMethodIsFindingEntityList_WithSingleStringParameter_WithCustomMarshaller_WhenNotFindingByHashKey()
        ...
        Mockito.lenient().when(mockUserEntityMetadata.getMarshallerForProperty("postCode")).thenReturn(marshaller);
    ...
    public void testExecute_WhenExistsQueryFindsNoEntity() {
        ...
        // Mockito.lenient().when(mockUserScanResults.size()).thenReturn(0);
        Mockito.lenient().when(mockUserScanResults.isEmpty()).thenReturn(true);
        Mockito.lenient().when(mockDynamoDBOperations.scan(userClassCaptor.capture(), scanCaptor.capture()))
                .thenReturn(mockUserScanResults);
    ...
    public void testExecute_WhenExistsQueryFindsOneEntity() {
        ...
        // Mockito.lenient().when(mockUserScanResults.get(0)).thenReturn(mockUser);
        // Mockito.lenient().when(mockUserScanResults.size()).thenReturn(1);
        Mockito.lenient().when(mockUserScanResults.isEmpty()).thenReturn(false);
        Mockito.lenient().when(mockDynamoDBOperations.scan(userClassCaptor.capture(), scanCaptor.capture()))
                .thenReturn(mockUserScanResults);
    ...
    public void testExecute_WhenExistsQueryFindsMultipleEntities() {
        ...
        // Mockito.lenient().when(mockUserScanResults.get(0)).thenReturn(mockUser);
        // Mockito.lenient().when(mockUserScanResults.get(1)).thenReturn(mockUser);
        // Mockito.lenient().when(mockUserScanResults.size()).thenReturn(2);
        Mockito.lenient().when(mockUserScanResults.isEmpty()).thenReturn(false);
        Mockito.lenient().when(mockDynamoDBOperations.scan(userClassCaptor.capture(), scanCaptor.capture()))
                .thenReturn(mockUserScanResults);
