...
public class DynamoDBIdIsHashAndRangeKeyEntityInformationImplUnitTest {
    ...
    @BeforeEach
    public void setup() {
        Mockito.lenient().when(mockPlaylistEntityMetadata.getHashAndRangeKeyExtractor(PlaylistId.class))
                .thenReturn(mockHashAndRangeKeyExtractor);
        Mockito.lenient().when(mockHashAndRangeKeyExtractor.getHashKey(mockPlaylistId)).thenReturn(mockHashKey);
        Mockito.lenient().when(mockHashAndRangeKeyExtractor.getRangeKey(mockPlaylistId)).thenReturn(mockRangeKey);

        Mockito.lenient().when(mockPlaylistEntityMetadata.getHashKeyPropertyName()).thenReturn("playlistHashKeyPropertyName");
        Mockito.lenient().when(mockPlaylistEntityMetadata.getHashKeyPropotypeEntityForHashKey("somePlaylistHashKey"))
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.isCompositeHashAndRangeKeyProperty("compositeIdProperty"))
                .thenReturn(true);
        Mockito.lenient().when(mockPlaylistEntityMetadata.isCompositeHashAndRangeKeyProperty("nonCompositeIdProperty"))
                .thenReturn(false);
    ...
    public void testGetPrototypeEntityForHashKey_DelegatesToDynamoDBEntityMetadata_IrrespectiveOfEntityInformationSetup() {
        ...
        Mockito.lenient().when(mockPlaylistEntityMetadata.getHashKeyPropotypeEntityForHashKey("someHashKey"))
